<form method="POST" action="editar_action.php">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="perecivel" value="0" id="false">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="categoria" value="alimentacao" id="alimentacao">
